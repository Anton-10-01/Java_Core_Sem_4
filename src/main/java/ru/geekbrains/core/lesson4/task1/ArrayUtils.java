...
public class ArrayUtils {
     ...
     * @throws MyArrayDataException некоректный формат данных
     */
    ...
    /**
     * Вспомагательный метод, преобразует значение элемента к числу
     * @param s значение элемента
     * @param x индекс элемента в массиве
     * @param y индекс элемента в массиве
     * @return число
     * @throws MyArrayDataException Некореектный формат данных
     */
    private int parseElement(String s, int x, int y) throws MyArrayDataException {
        try {
            ...
            throw new MyArrayDataException("Некореектный формат данных", x, y);
        }
    }
